...
export declare const Dialog: ({ __typename, confirmButton, cancelButton, closeButton, trigger, advancedConfigs, ...props }: DialogProps) => import("react").FunctionComponentElement<import(".").DialogProps>;
